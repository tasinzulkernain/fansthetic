...
const Trending = props => {
    ...
    useEffect(() => {
		...
		axios({url: '/products/', ...axiosConfig})
		.then(d => {
                        ...
                        <div className="grid_item">
                            <figure>
                                ...
                                <a href={`/product/?id=${product.id}`}>
                                    <img className="img-fluid" src={product.thumbnail} data-src="img/products/shoes/1.jpg" alt />
                                    <img className="img-fluid" src={product.thumbnail} data-src="img/products/shoes/1_b.jpg" alt />
                                </a>
                            </figure>
