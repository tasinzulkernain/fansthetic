...
const Product = props => {
    const { product, add_to_cart, remove_from_cart } = props;
    return (
        <div class="col-6 col-md-4">
            <div class="grid_item">
                ...
                <ul>
                    <li><a href="#0" class="tooltip-1" data-toggle="tooltip" data-placement="left" title="Add to Wishlist"><i class="ti-heart"></i><span>Add to Wishlist</span></a></li>
